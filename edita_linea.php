...
$x=0;
 session_start();  
  if ($_SESSION["nivel"]=='3') {
	 $x=1; include("php/func_admin.php");
  ...
  <table width="694"  border="0" cellspacing="0">
    <tr>
      ...
      <td align="left"><label for="cod_vehi3"></label>
        <select name="linea" class="Estilo14" id="linea" onchange="xajax_datos_lin(xajax.getFormValues('form1'))">
          <? echo $opciones;?>
        </select></td>
    </tr>
    <tr>
      ...
      <td align="left"><label for="anden"></label>
        <input name="anden" type="text" id="anden" size="2" maxlength="2"  onkeypress="javascript: return validarnum(event);" onchange="xajax_validar_puesto(xajax.getFormValues('form1'),'2')"/>
    ...
    <tr>
      <td width="49%" align="right"><input type="button" class="boton" name="guardar" value="Guardar" id="guardar"  onclick="xajax_validarlinea(xajax.getFormValues('form1'),'3');" /></td>
