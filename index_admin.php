<?php
$x=0;
 session_start();  date_default_timezone_set('America/Caracas');
  if ($_SESSION["nivel"]=='3') {
	 $x=1;
	 switch(date("m")){
	 case 1: 
...
<!-- InstanceBeginEditable name="EditRegion3" -->
	<div  >
   	  ...
   	  <div > <form  method="post" enctype="multipart/form-data" name="form1" id="form1" >
<fieldset >
  <legend align="right" class="legend" style="font-size: 18px">
      <strong style="color: #FFF">Inicio </strong></legend><p>&nbsp;</p>
  <table width="896" border="0" cellspacing="0">
    <tr>
      <td width="51%" colspan="2" align="center"><p>&nbsp;</p>
        <p>&nbsp;</p>
