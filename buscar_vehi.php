...
<fieldset >
  <legend class="legend" align="right">Chequear Vehiculo</legend>
  <p>&nbsp;</p>
  <table width="801" border="0" cellspacing="0" class="Estilo18">
    <tr  id="cod_vehi">
      ...
      <td width="51%" align="left"><label for="cod_vehi"></label>
        <input name="cod" type="text" id="cod" onkeypress="return validarnumeros_vehi(event)" size="4" maxlength="5"  autocomplete="off" autofocus="autofocus" onchange="xajax_revisa_vehi2(this.value)" class="Estilo18"/> 
    ...
    <tr id="pagar" style="display:none">
      <td colspan="2"><table width="100%" height="409" border="0" cellspacing="0" >
        <tr  >
          <td width="49%" height="48" align="right">Código del Vehículo&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="hidden" name="cod_vehi3" id="cod_vehi3"  value="0"/></td>
        ...
        <tr  id="cod_vehi7">
          ...
          <td align="left" id="monto2"><label for="cod_vehi7"></label>
            <input name="pago" type="text" class="Estilo18" id="pago"    onchange="xajax_pagar_vehi2(this.title,this.value, this.alt)"  autofocus="autofocus" size="2" maxlength="2" onkeypress="return validarnumeros(event)"/>
            Bs</td>
        </tr>
        <tr  id="cod_vehi6">
