...
<style type="text/css">
#principal #contenido fieldset table {
	text-align: center;
}
</style>
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="EditRegion3" -->
	<form id="form1" name="form1" method="post" action=""><div>
		<header></header>
   	  <div >
<fieldset >
  <legend class="legend" align="right">Vehiculos morosos</legend>
  <p>&nbsp;</p>
  <table width="880 px%" border="0" cellspacing="0">
    <tr style="text-align: center">
      ...
      <td width="45%">Hasta
        ...
        &nbsp;&nbsp; <span style="cursor:pointer; color: rgba(0,0,255,1);"  onclick="xajax_salida_vehi(xajax.getFormValues('form1'),'2')">Buscar</span></td>
      <td width="14%">&nbsp;</td>
    </tr>
    <tr>
