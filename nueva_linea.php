...
<form  method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return false" ><fieldset >
  ...
  <table width="681" height="242" border="0" cellspacing="0">
    <tr>
      <td width="49%" align="right">Número de anden&nbsp;&nbsp;&nbsp;&nbsp; </td>
      <td width="51%" align="left"><label for="anden"></label>
        <input name="anden" type="text" id="anden" size="2" maxlength="2" autofocus="autofocus" 
        onkeypress="javascript: return validarnum(event);"/>
        <select name="tipo_anden" id="tipo_anden"  onchange="xajax_validar_puesto(xajax.getFormValues('form1'),'1')">
    ...
    <tr>
      <td align="right">Código de linea&nbsp;&nbsp;&nbsp;&nbsp;</td>
      <td align="left"><label for="anden"></label><input name="cod_linea" type="text" id="cod_linea" size="1" maxlength="3" 
       onkeypress="return validarnumeros_vehi(event)"/></td>
    </tr>
    <tr>
      <td align="right">Nombre de la línea&nbsp;&nbsp;&nbsp;&nbsp; </td>
      <td align="left"><label for="cod_vehi3"></label>
        <input name="nombre_linea" type="text" id="nombre_linea" size="20" maxlength="50"  
        onchange="xajax_validar_linea(xajax.getFormValues('form1'),'1')" /></td>
    </tr>
    <tr>
      <td align="right">Ruta&nbsp;&nbsp;&nbsp;&nbsp;</td>
      <td align="left"><label for="cod_vehi4"></label><input name="ruta" type="text" id="ruta" size="20" maxlength="50"  
       /></td>
    </tr>
    <tr>
      <td align="right">Tipo de ruta&nbsp;&nbsp;&nbsp;&nbsp; </td>
    ...
    <tr>
      <td align="right">Costo del pasaje&nbsp;&nbsp;&nbsp;&nbsp; </td>
    ...
    <tr>
      <td align="right"><input type="button" class="boton" name="guardar" value="Guardar" id="guardar"  onclick="xajax_validarlinea(xajax.getFormValues('form1'),'1');" /></td>
