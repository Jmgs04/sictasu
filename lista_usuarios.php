...
$x=0;
 session_start();  
  if ($_SESSION["nivel"]=='3') {
	 ...
	 $query="SELECT * from usuario where estado='activo' order by nivel";
...
<form  method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return false" ><fieldset >
  ...
  <table width="880" border="1" cellspacing="0">
    <tr align="center">
      ...
      <td width="26%"><strong>Nombres y Apellidos</strong></td>
      <td width="14%"><strong>Usuario</strong></td>
      <td width="14%"><strong>Nivel</strong></td>
      <td width="14%"><strong>Turno</strong></td>
	...
	echo'<tr align="center" height="35">
      ...
      <td>'.$row['nivel'].'</td>
      <td>'.$t.'</td>
      <td>&nbsp;&nbsp;&nbsp;&nbsp;<a href="editar_us.php?id="'.$row['ced_usu'].'" ><img src="/sictasu/imagenes/edit_male_user_98373.jpg" width="27" height="25" alt="Modificar" style="cursor:pointer"/></a>&nbsp;&nbsp;&nbsp;&nbsp;<img src="/sictasu/imagenes/Remove-Male-User.jpg" width="24" height="26" alt="'.$row['ced_usu'].'"  style="cursor:pointer" onclick="if(confirm(\'Desea eliminar este usuario?\'))xajax_borrar_usu(this.alt)"/></td>
      </tr>';} ?>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
