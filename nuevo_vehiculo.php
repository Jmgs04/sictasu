...
<fieldset >
  ...
  <table width="100%" height="283" border="0" cellspacing="0">
    <tr>
      <td width="49%" align="right">Nombre de la línea&nbsp;&nbsp;&nbsp;&nbsp; </td>
    ...
    <tr>
      <td align="right">Tipo de vehículo&nbsp;&nbsp;&nbsp;&nbsp; </td>
      <td align="left"><label for="ced_usu2"></label>
        <label for="linea2"></label>
