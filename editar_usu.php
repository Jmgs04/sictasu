  ...
  <table width="825 px" height="258" border="0" cellspacing="0">
    <tr>
      ...
      <td width="51%" align="left"><label for="ced_usu"></label>
        ...
        onchange="xajax_busca_usu(xajax.getFormValues('form1'),'2')" />
        &nbsp;&nbsp;<img src="/sictasu/imagenes/buscar.png" width="23" height="27" />
        <input type="hidden" name="ced_change" id="ced_change" /></td>
    </tr>
    <tr>
      <td colspan="2" align="right"><table width="100%" border="0" cellspacing="0" id="datos_usu" style="display:none">
        <tr>
        ...
        <tr>
          ...
          <td align="left"  id="nivel1">
           </td>
        </tr>
        <tr>
          <td height="31" align="right">Turno&nbsp;&nbsp;&nbsp;</td>
          <td align="left" id="turno1" ></td>
        </tr>
        <tr>
    ...
    <tr id="botones" style="display:none">
